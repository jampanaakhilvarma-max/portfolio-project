      ...
      <div className="max-w-6xl mx-auto px-4 py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">
                ...
                <span>HR-Tech & Agentic AI Product Leader</span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                ...
                className="flex items-center space-x-2 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-colors"
              >
          ...
          <div className="relative">
            {/* Profile Image */}
            <div className="relative z-10 mx-auto w-80 h-80 bg-gradient-to-br from-blue-400 to-purple-500 rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center">
              <img src="/assets/1639191622837.jpg" alt="Profile" className="w-48 h-48 object-contain mx-auto" />
            </div>

            {/* Floating Cards */}
            <div
              className="absolute -top-4 -right-12 bg-white rounded-xl shadow-lg p-4 border border-gray-100"
              style={{ width: '200px' }}
            >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Staffing Delays</p>
